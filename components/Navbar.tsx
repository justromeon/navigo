...
export default function Navbar({session}: {session: Session | null}) {
  ...
  return (
    <nav className="bg-white shadow-md py-4 border-b border-border">
      {" "}
...
function UserNav() {
  return (
    <>
      ...
      <button 
        className="flex items-center justify-center bg-foreground hover:bg-ring text-primary-foreground p-2 rounded-sm cursor-pointer"
        onClick={logout}
      >
        Sign Out
      </button>
